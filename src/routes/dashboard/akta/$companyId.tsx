...
function CompanyDetailComponent() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-8">
      ...
      {/* 2. INFORMASI PERUSAHAAN (Status Fields) */}
                ...
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Detail keterangan dan catatan untuk dokumen ini.
                      </DialogDescription>
                    </DialogHeader>
                    <div className="mt-4 p-4 bg-muted rounded-lg text-sm leading-relaxed italic text-muted-foreground">
                      "{akta.keterangan}"
                    </div>
                  </DialogContent>
                </Dialog>
